...
def proc_rgb():
    ...
    print("Build mesh")
    if METASHAPE_V2_PLUS:
        chunk.buildModel(surface_type=Metashape.HeightField, source_data=Metashape.TiePointsData,
...
def proc_multispec():
    ...
    #
    chunk.calibrateReflectance(use_reflectance_panels=True, use_sun_sensor=False)
    ...
    print("Build orthomosaic")
    chunk.buildOrthomosaic(surface_data=Metashape.DataSource.ModelData, refine_seamlines=True) # Default Mosaic Blending
    doc.save()
